...
export default function ModuleDynamicFormBuilder() {
    ...
    const otherFields = useMemo(
        () => (allFields || []).map((f) => ({ id: f.id, label: f.label })),
        [allFields]
    );
                                        ...
                                        >
                                            ...
                                            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, marginTop: 12 }}>
                                                ...
                                                <FormControl
                                                    ...
                                                    sx={{
                                                        "& .MuiInputBase-root": {
                                                            paddingBottom: "0px", // align with TextField underline
                                                        },
                                                        "& .MuiInput-input": {
                                                            padding: "0px 0 1px", // fine-tune text vertical spacing
                                                            fontSize: "0.875rem",
                                                        },
                                                    }}
                                                >
                                            ...
                                            {/* Conditional Logic */}
                                            {/* <div style={{ marginTop: 12, fontWeight: 600 }}>Conditional Logic</div>

                      {(editorField.conditions || []).map((cond, index) => (
                        <div
                          key={index}
                          style={{
                            marginTop: 16,
                        ...
                        > */}
                            ...
                            >
                              ...
                              <Select
                                key={editorField.label} value={editorField.label}
                                disabled
                                label="Depends On"
                              >
                                <MenuItem value={editorField?.label || ""}>
                                  {editorField?.label || "Current Field"}
                                </MenuItem>
                              </Select>
                            </FormControl>
                            ...
                            <div style={{ fontWeight: 500, marginBottom: 6 }}>Actions</div>

                            {(cond.actions || []).map((action, aIndex) => (
                              <div
                                key={aIndex}
                                style={{
                                  display: "grid",
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    {otherFields
                                      .filter((f) => f.id !== editorField.id)
                                      .map((f) => (
                                        <MenuItem key={f.id} value={f.label}>
                                          {f.label}
                                        </MenuItem>
                                      ))}
                                  </Select>
                                ...
                                >
                                  ...
                                  <Select
                                    ...
                                    label="Action Type"
                                  >
                                    <MenuItem value="disableField">Disable Field</MenuItem>
                                    <MenuItem value="enableField">Enable Field</MenuItem>
                                    <MenuItem value="setRequiredFalse">Make Optional</MenuItem>
                                    <MenuItem value="setRequiredTrue">Make Required</MenuItem>
                                  </Select>
                                </FormControl>
                            ...
                            <Button
                              ...
                              onClick={() =>
                                markDirtySetEditor((prev) => {
                                  const updated = { ...prev };
                                  const newConditions = [...(updated.conditions || [])];
                                  const cond = { ...newConditions[index] };

                                  cond.actions = [...(cond.actions || []), { type: "", target: "" }];
