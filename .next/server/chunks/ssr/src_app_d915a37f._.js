...
"[project]/src/app/dashboard/consignee-master/edit/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EditConsignee = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchVehicleData = async ()=>{
            try {
                ...
                const structureRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApi"])("/fieldindex01/form?entity_name=Vehicle");
            ...
            const initialForm = formSchema.reduce((acc, tab)=>{
                tab.sections.forEach((section)=>{
                    section.fields.forEach((field)=>{
                        ...
                        // 🔹 Debug Log
                        console.log("🔍 Mapping Field:", field.key, "→", normalizedKey, "| Value from API:", consignee?.[normalizedKey]);
                        acc[field.key] = consignee?.[normalizedKey] ?? (field.type === "multiselect" ? [] : field.type === "switch" ? false : "");
                    });
                });
                return acc;
            }, {});
    ...
    const handleSave = async ()=>{
        try {
            ...
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$vehicleSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateItem"])({
                id,
                data: payload
            })).unwrap();
...
//# sourceMappingURL=src_app_d915a37f._.js.map