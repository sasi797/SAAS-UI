...
function VehicleList() {
    ...
    //     { user_id: 3, username: "alex_smith", email: "alex@example.com", first_name: "Alex", last_name: "Smith", is_active: true },
    //     { user_id: 4, username: "emily_jones", email: "emily@example.com", first_name: "Emily", last_name: "Jones", is_active: true },
    //     { user_id: 5, username: "michael_brown", email: "michael@example.com", first_name: "Michael", last_name: "Brown", is_active: false },
    //     { user_id: 6, username: "sarah_white", email: "sarah@example.com", first_name: "Sarah", last_name: "White", is_active: true },
    //     { user_id: 7, username: "david_clark", email: "david@example.com", first_name: "David", last_name: "Clark", is_active: true },
    //     { user_id: 8, username: "laura_martin", email: "laura@example.com", first_name: "Laura", last_name: "Martin", is_active: false },
    //     { user_id: 9, username: "chris_lewis", email: "chris@example.com", first_name: "Chris", last_name: "Lewis", is_active: true },
    //     { user_id: 10, username: "amy_wilson", email: "amy@example.com", first_name: "Amy", last_name: "Wilson", is_active: true },
    //     { user_id: 11, username: "ryan_hall", email: "ryan@example.com", first_name: "Ryan", last_name: "Hall", is_active: false },
    //     { user_id: 12, username: "lisa_adams", email: "lisa@example.com", first_name: "Lisa", last_name: "Adams", is_active: true },
    //     { user_id: 13, username: "kevin_moore", email: "kevin@example.com", first_name: "Kevin", last_name: "Moore", is_active: true },
    //     { user_id: 14, username: "natalie_taylor", email: "natalie@example.com", first_name: "Natalie", last_name: "Taylor", is_active: false },
    //     { user_id: 15, username: "brian_anderson", email: "brian@example.com", first_name: "Brian", last_name: "Anderson", is_active: true },
    //     { user_id: 16, username: "megan_thomas", email: "megan@example.com", first_name: "Megan", last_name: "Thomas", is_active: true },
    //     { user_id: 17, username: "joshua_jackson", email: "joshua@example.com", first_name: "Joshua", last_name: "Jackson", is_active: false },
    //     { user_id: 18, username: "olivia_harris", email: "olivia@example.com", first_name: "Olivia", last_name: "Harris", is_active: true },
    //     { user_id: 19, username: "ethan_martinez", email: "ethan@example.com", first_name: "Ethan", last_name: "Martinez", is_active: true },
    //     { user_id: 20, username: "sophia_robinson", email: "sophia@example.com", first_name: "Sophia", last_name: "Robinson", is_active: false },
    // ];
    // const columns = [
    //     { key: "username", label: "Username", icon: <MuiIcons.Person fontSize="small" /> },
    //     { key: "email", label: "Email", icon: <MuiIcons.Email fontSize="small" /> },
    //     { key: "first_name", label: "First Name", icon: <MuiIcons.Badge fontSize="small" /> },
    //     { key: "last_name", label: "Last Name", icon: <MuiIcons.Badge fontSize="small" /> },
    //     { key: "is_active", label: "Active", icon: <MuiIcons.CheckCircleOutline fontSize="small" />, render: (val) => (val ? "Yes" : "No") },
    //     {
    //         key: "actions",
    //         label: "Actions",
    ...
    //                             p: 0.5,
    //                         }}
    //                         onClick={() => router.push(`/dashboard/vehicle-master/edit/${row.user_id}`)}
    //                     >
    ...
    //                             p: 0.5,
    //                         }}
    //                         onClick={() => console.log("Delete Vehicle", row.user_id)}
    //                     >
    ...
    useEffect(()=>{
        const fetchColumns = async ()=>{
            ...
            const dynamicColumns = result.data.map((col)=>({
                    key: col.key,
                    label: col.label,
                    icon: col.icon ? React.createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__[col.icon], {
                        fontSize: "small"
                    }) : null
                }));
            // Merge action column
...
//# sourceMappingURL=src_app_38e05188._.js.map