...
"[project]/src/app/dashboard/route-master/edit/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EditRoute = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchRouteData = async ()=>{
            try {
                ...
                const encryptedResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApi"])("fieldindex01/form/route_master");
                ...
                if (id) {
                    const res = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$routeMasterGetOne$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getById"])(id)).unwrap();
                    ...
                    section.fields.forEach((field)=>{
                        ...
                        if (arrayFieldKeys.includes(field.key)) {
                            revenueArr.forEach((revItem, idx)=>{
                                ...
                                acc[suffixedName] = revItem?.[field.key] ?? (field.type === "multiselect" ? [] : field.type === "switch" ? false : "");
    ...
    const handleSave = async ()=>{
        try {
            ...
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$routeMasterPostPut$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateItem"])({
                id,
...
//# sourceMappingURL=src_app_f74eb32d._.js.map