    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            formSchema[activeTab]?.sections.map((section, sIdx)=>{
                ...
                //   (section.title || "").toLowerCase() === "document";
                // const key = dynKey(tIdx, sIdx);
                ...
                //   }));
                // }
                // Determine if section is dynamic (Document or Load Info)
                const sectionTitle = (section.title || "").toLowerCase();
                const isDynamicSection = sectionTitle === "document" || sectionTitle === "load info";
                // Generate dynamic key for tracking
                const key = dynKey(tIdx, sIdx);
                // Ensure dynamic section exists (defensive)
...
"[project]/src/app/dashboard/driver-master/add/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AddDriver = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchDriverFields = async ()=>{
            ...
            try {
                const encryptedResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApi"])("fieldindex01/form/driver_master");
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$driverSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createItem"])(encryptedPayloadData)).unwrap();
...
const __TURBOPACK__default__export__ = AddDriver;
}),

};

//# sourceMappingURL=src_app_1d4c3b0e._.js.map