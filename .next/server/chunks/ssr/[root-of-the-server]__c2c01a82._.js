...
const encryptParams = async (payload)=>{
    try {
        const secret = new TextEncoder().encode(process.env.REACT_APP_ENCRYPTION_SECRET);
...
const getApi = async (url)=>{
    ...
    const selectedclientid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$SessionStorageSecurity$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["customDecrypt"])(sessionStorage.getItem("clientid")) || "clientid";
    ...
    if (selectedclientid && selectedclientid !== "null") {
        headers.clientid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$SessionStorageSecurity$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["customEncrypt"])(selectedclientid);
    }
    try {
        const response = await fetch(fullUrl, {
            method: "GET",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2c01a82._.js.map