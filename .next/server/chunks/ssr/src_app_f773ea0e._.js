...
"[project]/src/app/dashboard/driver-master/edit/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EditDriver = ()=>{
    ...
    const driver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$driverSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["selectDriverItem"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchVehicleData = async ()=>{
            try {
                ...
                if (id) {
                    const res = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$driverSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getById"])(id)).unwrap();
            ...
            const initialForm = formSchema.reduce((acc, tab)=>{
                tab.sections.forEach((section)=>{
                    section.fields.forEach((field)=>{
                        ...
                        // 🔹 Debug Log
                        console.log("🔍 Mapping Field:", field.key, "→", normalizedKey, "| Value from API:", driver?.[normalizedKey]);
                        acc[field.key] = driver?.[normalizedKey] ?? (field.type === "multiselect" ? [] : field.type === "switch" ? false : "");
                    });
                });
                return acc;
            }, {});
    ...
    const handleSave = async ()=>{
        try {
            ...
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$driverSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateItem"])({
                id,
...
//# sourceMappingURL=src_app_f773ea0e._.js.map