            ...
            const initialForm = formSchema.reduce((acc, tab)=>{
                tab.sections.forEach((section)=>{
                    section.fields.forEach((field)=>{
                        ...
                        // 🔹 Debug Log
                        console.log("🔍 Mapping Field:", field.key, "→", normalizedKey, "| Value from API:", client?.[normalizedKey]);
                        acc[field.key] = client?.[normalizedKey] ?? (field.type === "multiselect" ? [] : field.type === "switch" ? false : "");
                    });
                });
                return acc;
            }, {});
...
//# sourceMappingURL=src_app_0fd7cbae._.js.map