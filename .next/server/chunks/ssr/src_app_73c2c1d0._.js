            ...
            const initialForm = formSchema.reduce((acc, tab)=>{
                tab.sections.forEach((section)=>{
                    section.fields.forEach((field)=>{
                        ...
                        // 🔹 Debug Log
                        console.log("🔍 Mapping Field:", field.key, "→", normalizedKey, "| Value from API:", location?.[normalizedKey]);
                        acc[field.key] = location?.[normalizedKey] ?? (field.type === "multiselect" ? [] : field.type === "switch" ? false : "");
                    });
                });
                return acc;
            }, {});
...
//# sourceMappingURL=src_app_73c2c1d0._.js.map