...
"[project]/src/app/dashboard/vehicle-master/edit/[id]/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EditUser = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchUserFields = async ()=>{
            ...
            try {
                ...
                const userDataRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApi"])(`/vehicles/${id}`); // 👈 API for user details
                    ...
                    const initialForm = structure.reduce((acc, tab)=>{
                        tab.sections.forEach((section)=>{
                            section.fields.forEach((field)=>{
                                acc[field.key] = userDataRes?.[field.key] ?? (field.type === "multiselect" ? [] : field.type === "switch" ? false : "");
                            });
                        });
                        return acc;
                    }, {});
    ...
    const handleSave = async ()=>{
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$putApiMethod$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["putApi"])(`/vehicles/${id}`, form);
            if (res?.status_code === 200) {
                ...
                const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApi"])(`/vehicles/${id}`);
                if (updated?.data) setForm(updated.data);
            } else {
                setSnackbar({
                    open: true,
...
//# sourceMappingURL=src_78060875._.js.map