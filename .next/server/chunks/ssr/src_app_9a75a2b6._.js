...
function UserList() {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$userSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteItem"])(id)).unwrap();
            console.log("✅ Deleted user:", result);
            // Refresh the list
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$userSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAll"])());
        } catch (error) {
    ...
    const fetchColumns = async ()=>{
        try {
            ...
            const encryptedResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApi"])("fieldindex01/table/user_master");
    ...
    const fetchUserData = async ()=>{
        try {
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$userSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAll"])()).unwrap();
        } catch (error) {
