            ...
            const initialForm = formSchema.reduce((acc, tab)=>{
                tab.sections.forEach((section)=>{
                    section.fields.forEach((field)=>{
                        ...
                        // 🔹 Debug Log
                        console.log("🔍 Mapping Field:", field.key, "→", normalizedKey, "| Value from API:", vehicle?.[normalizedKey]);
                        acc[field.key] = vehicle?.[normalizedKey] ?? (field.type === "multiselect" ? [] : field.type === "switch" ? false : "");
                    });
                });
                return acc;
            }, {});
...
//# sourceMappingURL=src_app_64e8c3c0._.js.map