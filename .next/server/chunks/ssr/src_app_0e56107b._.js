...
const EditVehicle = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (vehicle && formSchema.length > 0) {
            ...
            const insuranceArr = Array.isArray(source?.insurance) ? source.insurance : [];
                    ...
                    section.fields.forEach((field)=>{
                        ...
                        if (arrayFieldKeys.includes(field.key) && insuranceArr.length > 0) {
                            insuranceArr.forEach((insItem, idx)=>{
                                ...
                                acc[suffixedName] = insItem?.[field.key] ?? (field.type === "multiselect" ? [] : field.type === "switch" ? false : "");
                                // ⭐ Store the ID of this insurance row
                                acc[`id_${idx}`] = insItem?.id ?? null;
                                console.log("🔍 Mapping Insurance Field:", field.key, "→", suffixedName, "| Value from API:", insItem?.[field.key]);
                            });
...
//# sourceMappingURL=src_app_0e56107b._.js.map