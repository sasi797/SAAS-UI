...
"[project]/src/app/dashboard/location-master/add/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AddLocation = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddLocation.useEffect": ()=>{
            const fetchLocationFields = {
                "AddLocation.useEffect.fetchLocationFields": async ()=>{
                    ...
                    try {
                        ...
                        if (result === null || result === void 0 ? void 0 : result.structure) {
                            ...
                            const initialForm = structure.reduce({
                                "AddLocation.useEffect.fetchLocationFields.initialForm": (acc, tab)=>{
                                    tab.sections.forEach({
                                        "AddLocation.useEffect.fetchLocationFields.initialForm": (section)=>{
                                            section.fields.forEach({
                                                "AddLocation.useEffect.fetchLocationFields.initialForm": (field)=>{
                                                    acc[field.key] = field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                                }
                                            }["AddLocation.useEffect.fetchLocationFields.initialForm"]);
                                        }
                                    }["AddLocation.useEffect.fetchLocationFields.initialForm"]);
                                    return acc;
                                }
            ...
            }["AddLocation.useEffect.fetchLocationFields"];
            fetchLocationFields();
        // eslint-disable-next-line react-hooks/exhaustive-deps
        }
    }["AddLocation.useEffect"], []);
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$locationSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createItem"])(encryptedPayloadData)).unwrap();
    ...
    if (loadingFields) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$LoadingSpinner$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            ...
            fileName: "[project]/src/app/dashboard/location-master/add/page.js",
            lineNumber: 141,
            columnNumber: 12
        }, ("TURBOPACK compile-time value", void 0));
    }
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                        ...
                                        children: "Fill in the details below to add a new location."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/location-master/add/page.js",
                                        lineNumber: 198,
                                        columnNumber: 13
...
_s(AddLocation, "/pqIzIy0BJQtmYEOn8y//JLTeEU=", false, function() {
    return [
...
//# sourceMappingURL=src_app_9ed309f8._.js.map