...
"[project]/src/app/dashboard/user-codes/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const UserCodesPage = ()=>{
    ...
    const [activeModule, setActiveModule] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserCodesPage.useEffect": ()=>{
            ...
            const uniqueModules = [
                ...new Set(dataset.map({
                    "UserCodesPage.useEffect": (d)=>d.group_type
                }["UserCodesPage.useEffect"]))
            ];
    ...
    const fieldsOfActiveModule = codes.filter((c)=>c.group_type === activeModule);
    const handleAdd = ()=>{
        if (!newOption.trim()) return;
        const updated = codes.map((item)=>item.field_name === selectedField.field_name ? {
                ...item,
                field_values: [
                    ...item.field_values,
                    newOption
...
_s(UserCodesPage, "isjkWE5WjMrPU9FhItKOubK+QFg=");
_c = UserCodesPage;
const __TURBOPACK__default__export__ = UserCodesPage;
var _c;
__turbopack_context__.k.register(_c, "UserCodesPage");
...
//# sourceMappingURL=src_app_dashboard_user-codes_page_d4b693b9.js.map