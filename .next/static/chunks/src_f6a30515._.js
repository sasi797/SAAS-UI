...
const CustomTextarea = (param)=>{
    let { label, name, value, onChange, required, disabled, rows = 4 } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$TextField$2f$TextField$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TextField$3e$__["TextField"], {
        size: "small",
        label: label,
        name: name,
...
const AddVehicle = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddVehicle.useEffect": ()=>{
            const fetchVehicleFields = {
                "AddVehicle.useEffect.fetchVehicleFields": async ()=>{
                    setLoading(true);
                    try {
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApi"])("/fieldindex01/vehicleform?entity_name=Vehicle");
                        ...
                        if (result === null || result === void 0 ? void 0 : result.structure) {
                            ...
                            const initialForm = structure.reduce({
                                "AddVehicle.useEffect.fetchVehicleFields.initialForm": (acc, tab)=>{
                                    tab.sections.forEach({
                                        "AddVehicle.useEffect.fetchVehicleFields.initialForm": (section)=>{
                                            section.fields.forEach({
                                                "AddVehicle.useEffect.fetchVehicleFields.initialForm": (field)=>{
                                                    acc[field.key] = field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                                }
                                            }["AddVehicle.useEffect.fetchVehicleFields.initialForm"]);
                                        }
                                    }["AddVehicle.useEffect.fetchVehicleFields.initialForm"]);
                                    return acc;
                                }
            ...
            }["AddVehicle.useEffect.fetchVehicleFields"];
            fetchVehicleFields();
        }
    }["AddVehicle.useEffect"], []);
    // === Handlers ===
...
_s(AddVehicle, "FK9mxQ7RuWnshE8N2Q7uqwAMUUo=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "AddVehicle");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_f6a30515._.js.map