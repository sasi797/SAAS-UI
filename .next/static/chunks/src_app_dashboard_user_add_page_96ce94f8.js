...
const AddUser = ()=>{
    ...
    const handleChange = (field, value)=>setForm({
            ...form,
            [field]: value
        });
    const handleSave = ()=>{
...
_s(AddUser, "HStpEd4GoSKra1OTUnwaQYGZJQY=", false, function() {
    return [
...
//# sourceMappingURL=src_app_dashboard_user_add_page_96ce94f8.js.map