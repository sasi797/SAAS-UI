                            ...
                            "EditVehicle.useEffect.initialForm": (section)=>{
                                section.fields.forEach({
                                    "EditVehicle.useEffect.initialForm": (field)=>{
                                        ...
                                        // 🔹 Debug Log
                                        console.log("🔍 Mapping Field:", field.key, "→", normalizedKey, "| Value from API:", vehicle === null || vehicle === void 0 ? void 0 : vehicle[normalizedKey]);
                                        var _vehicle_normalizedKey;
                                        acc[field.key] = (_vehicle_normalizedKey = vehicle === null || vehicle === void 0 ? void 0 : vehicle[normalizedKey]) !== null && _vehicle_normalizedKey !== void 0 ? _vehicle_normalizedKey : field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                    }
...
_s(EditVehicle, "Uazykve2ioL6ix5qQgaTul0ECCw=", false, function() {
    return [
...
//# sourceMappingURL=src_app_332e5214._.js.map