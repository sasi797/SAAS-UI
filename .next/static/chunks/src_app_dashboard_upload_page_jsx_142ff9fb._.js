...
const Upload = ()=>{
    ...
    const handleUpload = async ()=>{
        ...
        setLoading(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:8000/upload-resumes", formData, {
                headers: {
                    "Content-Type": "multipart/form-data"
                },
                responseType: "blob"
            });
            // Trigger download of Excel
...
//# sourceMappingURL=src_app_dashboard_upload_page_jsx_142ff9fb._.js.map