    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: (_formSchema_activeTab = formSchema[activeTab]) === null || _formSchema_activeTab === void 0 ? void 0 : _formSchema_activeTab.sections.map((section, sIdx)=>{
                    var _section_fields;
...
"[project]/src/app/dashboard/route-master/edit/[id]/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EditRoute = ()=>{
    ...
    const route = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$routeMasterGetOne$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectRouteOneItem"]);
    const loading = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$routeMasterGetOne$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectRouteOneLoading"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditRoute.useEffect": ()=>{
            const fetchRouteData = {
                "EditRoute.useEffect.fetchRouteData": async ()=>{
                    try {
                        ...
                        if (structureRes === null || structureRes === void 0 ? void 0 : structureRes.structure) {
                            console.log("structureRes?.structure", structureRes === null || structureRes === void 0 ? void 0 : structureRes.structure);
                            setFormSchema(structureRes.structure);
                        }
                        // 2️⃣ Fetch route details from API via Redux
                        if (id) {
                            const res = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$routeMasterGetOne$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getById"])(id)).unwrap();
            ...
            }["EditRoute.useEffect.fetchRouteData"];
            fetchRouteData();
        // eslint-disable-next-line react-hooks/exhaustive-deps
        }
    }["EditRoute.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditRoute.useEffect": ()=>{
            if (route && formSchema.length > 0) {
                var _route_data;
                const source = (_route_data = route.data) !== null && _route_data !== void 0 ? _route_data : route;
                console.log("route", route);
                console.log("source", source);
                const revenueArr = Array.isArray(source === null || source === void 0 ? void 0 : source.revenues) ? source.revenues : [];
                ...
                const initialForm = formSchema.reduce({
                    "EditRoute.useEffect.initialForm": (acc, tab)=>{
                        tab.sections.forEach({
                            "EditRoute.useEffect.initialForm": (section)=>{
                                section.fields.forEach({
                                    "EditRoute.useEffect.initialForm": (field)=>{
                                        const apiKey = field.key.toLowerCase().replace(/\s+/g, "_").replace(/[\/]+/g, "_").replace(/_+/g, "_");
                                        if (arrayFieldKeys.includes(field.key)) {
                                            revenueArr.forEach({
                                                "EditRoute.useEffect.initialForm": (revItem, idx)=>{
                                                    const suffixedName = "".concat(field.key, "_").concat(idx);
                                                    var _revItem_field_key;
                                                    acc[suffixedName] = (_revItem_field_key = revItem === null || revItem === void 0 ? void 0 : revItem[field.key]) !== null && _revItem_field_key !== void 0 ? _revItem_field_key : field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                                    var _revItem_revenue_id;
                                                    // ✅ map API revenue_id → form id
                                                    acc["id_".concat(idx)] = (_revItem_revenue_id = revItem === null || revItem === void 0 ? void 0 : revItem.revenue_id) !== null && _revItem_revenue_id !== void 0 ? _revItem_revenue_id : null;
                                                }
                                            }["EditRoute.useEffect.initialForm"]);
    ...
    const transformPayload = (data)=>{
        ...
        indices.forEach((i)=>{
            ...
            revenue_details.push({
                ...
                load_type: (_data_1 = data["load_type_".concat(i)]) !== null && _data_1 !== void 0 ? _data_1 : "",
                container_type: (_data_2 = data["container_type_".concat(i)]) !== null && _data_2 !== void 0 ? _data_2 : "",
                revenue: (_data_3 = data["revenue_".concat(i)]) !== null && _data_3 !== void 0 ? _data_3 : ""
            });
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$routeMasterPostPut$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateItem"])({
                id,
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Breadcrumbs$2f$Breadcrumbs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Breadcrumbs$3e$__["Breadcrumbs"], {
                                        separator: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$NavigateNext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            ...
                                            fileName: "[project]/src/app/dashboard/route-master/edit/[id]/page.js",
                                            lineNumber: 226,
                                            columnNumber: 17
                                        }, void 0),
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                        ...
                                        children: "Update the details below to modify this route."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/route-master/edit/[id]/page.js",
                                        lineNumber: 253,
                                        columnNumber: 13
...
_s(EditRoute, "nEaS7Wp1VKayjrUjYyGcIsn+DOU=", false, function() {
    return [
...
_c = EditRoute;
const __TURBOPACK__default__export__ = EditRoute;
var _c;
__turbopack_context__.k.register(_c, "EditRoute");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_5b53202a._.js.map