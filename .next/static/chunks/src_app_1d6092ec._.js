...
const EditClient = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditClient.useEffect": ()=>{
            const fetchClientData = {
                "EditClient.useEffect.fetchClientData": async ()=>{
                    try {
                        ...
                        if (id) {
                            const res = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$clientSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getById"])(id)).unwrap();
            ...
            }["EditClient.useEffect.fetchClientData"];
            fetchClientData();
        // eslint-disable-next-line react-hooks/exhaustive-deps
        }
    }["EditClient.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditClient.useEffect": ()=>{
            if (client && formSchema.length > 0) {
                var _client_data;
                const source = (_client_data = client.data) !== null && _client_data !== void 0 ? _client_data : client;
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$clientSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateItem"])({
                id,
...
_s(EditClient, "SryEMPudqS1W+F9WckNmTXfjWyw=", false, function() {
    return [
...
//# sourceMappingURL=src_app_1d6092ec._.js.map