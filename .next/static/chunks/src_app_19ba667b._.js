...
const AddUser = ()=>{
    ...
    const handleSave = async ()=>{
        try {
            const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$userSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createItem"])(formData)).unwrap(); // ✅ unwrap for proper await
...
_s(AddUser, "UaonJUYwV8pUhvNvKt4h8/60RSE=", false, function() {
    return [
...
//# sourceMappingURL=src_app_19ba667b._.js.map