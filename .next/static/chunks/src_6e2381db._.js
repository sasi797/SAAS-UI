...
const deleteApi = async (url)=>{
    ...
    const baseUrl = (_process_env_NEXT_PUBLIC_BASE_URL = ("TURBOPACK compile-time value", "http://91.208.184.64:8001")) === null || _process_env_NEXT_PUBLIC_BASE_URL === void 0 ? void 0 : _process_env_NEXT_PUBLIC_BASE_URL.replace(/\/+$/, ""); // strip trailing /
...
(()=>{
    const e = new Error("Cannot find module './features/consigneeSlice'");
...
//# sourceMappingURL=src_6e2381db._.js.map