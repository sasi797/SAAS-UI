...
const AddClient = ()=>{
    ...
    // === Fetch client fields dynamically ===
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddClient.useEffect": ()=>{
            const fetchVehicleFields = {
                "AddClient.useEffect.fetchVehicleFields": async ()=>{
                    ...
                    try {
                        ...
                        if (result === null || result === void 0 ? void 0 : result.structure) {
                            ...
                            const initialForm = structure.reduce({
                                "AddClient.useEffect.fetchVehicleFields.initialForm": (acc, tab)=>{
                                    tab.sections.forEach({
                                        "AddClient.useEffect.fetchVehicleFields.initialForm": (section)=>{
                                            section.fields.forEach({
                                                "AddClient.useEffect.fetchVehicleFields.initialForm": (field)=>{
                                                    acc[field.key] = field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                                }
                                            }["AddClient.useEffect.fetchVehicleFields.initialForm"]);
                                        }
                                    }["AddClient.useEffect.fetchVehicleFields.initialForm"]);
                                    return acc;
                                }
            ...
            }["AddClient.useEffect.fetchVehicleFields"];
            fetchVehicleFields();
        }
    }["AddClient.useEffect"], []);
    // === Handlers ===
...
_s(AddClient, "152cJxVw2hkJEJ/Vr0FTKH2Ttqo=", false, function() {
    return [
...
//# sourceMappingURL=src_app_921e0f85._.js.map