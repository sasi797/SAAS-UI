...
"[project]/src/app/dashboard/driver-master/edit/[id]/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EditDriver = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditDriver.useEffect": ()=>{
            const fetchVehicleData = {
                "EditDriver.useEffect.fetchVehicleData": async ()=>{
                    try {
                        ...
                        if (id) {
                            const res = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$driverSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getById"])(id)).unwrap();
            ...
            }["EditDriver.useEffect.fetchVehicleData"];
            fetchVehicleData();
        // eslint-disable-next-line react-hooks/exhaustive-deps
        }
    }["EditDriver.useEffect"], [
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$driverSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateItem"])({
                id,
...
_s(EditDriver, "tBAsYUURxRbDY9QDyMD7uEiLNbc=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "EditDriver");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_fd201ec2._.js.map