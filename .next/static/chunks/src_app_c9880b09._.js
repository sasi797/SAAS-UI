...
"[project]/src/app/dashboard/consignee-master/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ConsigneeList() {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Tooltip$2f$Tooltip$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Tooltip$3e$__["Tooltip"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$IconButton$2f$IconButton$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconButton$3e$__["IconButton"], {
                                    size: "small",
                                    onClick: ()=>router.push("/dashboard/consignee-master/edit/".concat(row.vehicle_id)),
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConsigneeList.useEffect": ()=>{
            const ws = new WebSocket("ws://localhost:8000/ws/vehicles");
            ws.onopen = ({
                "ConsigneeList.useEffect": ()=>console.log("✅ WebSocket connected")
            })["ConsigneeList.useEffect"];
            ws.onmessage = ({
                "ConsigneeList.useEffect": (event)=>{
                    try {
            ...
            ws.onclose = ({
                "ConsigneeList.useEffect": ()=>console.log("❌ WebSocket disconnected")
            })["ConsigneeList.useEffect"];
            return ({
                "ConsigneeList.useEffect": ()=>ws.close()
            })["ConsigneeList.useEffect"];
        }
    }["ConsigneeList.useEffect"], [
        dispatch
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConsigneeList.useEffect": ()=>{
            const loadSequentially = {
                "ConsigneeList.useEffect.loadSequentially": async ()=>{
                    await fetchColumns();
                    await fetchVehicleData();
                }
            }["ConsigneeList.useEffect.loadSequentially"];
            loadSequentially();
        }
    }["ConsigneeList.useEffect"], []);
    // === Render ===
...
_s(ConsigneeList, "O/3wQDoB5BZd3wfZbXMcfg4atMo=", false, function() {
    return [
...
_c = ConsigneeList;
var _c;
__turbopack_context__.k.register(_c, "ConsigneeList");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_c9880b09._.js.map