...
"[project]/src/app/dashboard/consignee-master/add/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AddConsignee = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddConsignee.useEffect": ()=>{
            const fetchVehicleFields = {
                "AddConsignee.useEffect.fetchVehicleFields": async ()=>{
                    setLoadingFields(true);
                    try {
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApi"])("/fieldindex01/form?entity_name=Vehicle");
                        ...
                        if (result === null || result === void 0 ? void 0 : result.structure) {
                            ...
                            const initialForm = structure.reduce({
                                "AddConsignee.useEffect.fetchVehicleFields.initialForm": (acc, tab)=>{
                                    tab.sections.forEach({
                                        "AddConsignee.useEffect.fetchVehicleFields.initialForm": (section)=>{
                                            section.fields.forEach({
                                                "AddConsignee.useEffect.fetchVehicleFields.initialForm": (field)=>{
                                                    acc[field.key] = field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                                }
                                            }["AddConsignee.useEffect.fetchVehicleFields.initialForm"]);
                                        }
                                    }["AddConsignee.useEffect.fetchVehicleFields.initialForm"]);
                                    return acc;
                                }
            ...
            }["AddConsignee.useEffect.fetchVehicleFields"];
            fetchVehicleFields();
        }
    }["AddConsignee.useEffect"], []);
    // === Handlers ===
    ...
    const handleSave = async ()=>{
        try {
            ...
            const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$vehicleSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createItem"])(payload)).unwrap();
    ...
    // === Loading State ===
    if (loadingFields) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$LoadingSpinner$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
...
_s(AddConsignee, "152cJxVw2hkJEJ/Vr0FTKH2Ttqo=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "AddConsignee");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_348d92e6._.js.map