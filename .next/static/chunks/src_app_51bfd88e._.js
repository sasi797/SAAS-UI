    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditLocation.useEffect": ()=>{
            const fetchVehicleData = {
                "EditLocation.useEffect.fetchVehicleData": async ()=>{
                    try {
            ...
            }["EditLocation.useEffect.fetchVehicleData"];
            fetchVehicleData();
        }
    }["EditLocation.useEffect"], [
        id,
                            ...
                            "EditLocation.useEffect.initialForm": (section)=>{
                                section.fields.forEach({
                                    "EditLocation.useEffect.initialForm": (field)=>{
                                        ...
                                        // 🔹 Debug Log
                                        console.log("🔍 Mapping Field:", field.key, "→", normalizedKey, "| Value from API:", location === null || location === void 0 ? void 0 : location[normalizedKey]);
                                        var _location_normalizedKey;
                                        acc[field.key] = (_location_normalizedKey = location === null || location === void 0 ? void 0 : location[normalizedKey]) !== null && _location_normalizedKey !== void 0 ? _location_normalizedKey : field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                    }
...
_s(EditLocation, "VqfJpHx7AJQPTYhzlX6rKQGYoCg=", false, function() {
    return [
...
//# sourceMappingURL=src_app_51bfd88e._.js.map