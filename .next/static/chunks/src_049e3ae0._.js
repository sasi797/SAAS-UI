...
const EditUser = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditUser.useEffect": ()=>{
            const fetchUserFields = {
                "EditUser.useEffect.fetchUserFields": async ()=>{
                    setLoading(true);
                    try {
                        ...
                        const userDataRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApi"])("/vehicles/".concat(id)); // 👈 API for user details
                        if (structureRes === null || structureRes === void 0 ? void 0 : structureRes.structure) {
                            ...
                            // initialize with user data or empty defaults
                            const initialForm = structure.reduce({
                                "EditUser.useEffect.fetchUserFields.initialForm": (acc, tab)=>{
                                    tab.sections.forEach({
                                        "EditUser.useEffect.fetchUserFields.initialForm": (section)=>{
                                            section.fields.forEach({
                                                "EditUser.useEffect.fetchUserFields.initialForm": (field)=>{
                                                    var _userDataRes_field_key;
                                                    acc[field.key] = (_userDataRes_field_key = userDataRes === null || userDataRes === void 0 ? void 0 : userDataRes[field.key]) !== null && _userDataRes_field_key !== void 0 ? _userDataRes_field_key : field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                                }
                                            }["EditUser.useEffect.fetchUserFields.initialForm"]);
                                        }
                                    }["EditUser.useEffect.fetchUserFields.initialForm"]);
                                    return acc;
                                }
                            ...
                            console.error("Unexpected form response:", structureRes);
                        }
                    } catch (error) {
            ...
            }["EditUser.useEffect.fetchUserFields"];
            fetchUserFields();
        }
    }["EditUser.useEffect"], [
        id
    ...
    const handleSave = async ()=>{
        try {
            setSaving(true);
            console.log("Updating vehicle:", form);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$putApiMethod$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["putApi"])("/vehicles/".concat(id), form);
            if ((res === null || res === void 0 ? void 0 : res.status_code) === 200) {
                ...
                const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApi"])("/vehicles/".concat(id));
                if (updated === null || updated === void 0 ? void 0 : updated.data) setForm(updated.data);
            } else {
                setSnackbar({
                    open: true,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                        ...
                                        children: "Update the user details below."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/dashboard/vehicle-master/edit/[id]/page.js",
                                        lineNumber: 161,
                                        columnNumber: 13
...
_s(EditUser, "NS8cpk9S1kbL6A6szIWRZR6qSow=", false, function() {
    return [
...
//# sourceMappingURL=src_049e3ae0._.js.map