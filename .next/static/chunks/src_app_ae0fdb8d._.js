...
const AddLocation = ()=>{
    ...
    // === Fetch location fields dynamically ===
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddLocation.useEffect": ()=>{
            const fetchVehicleFields = {
                "AddLocation.useEffect.fetchVehicleFields": async ()=>{
                    ...
                    try {
                        ...
                        if (result === null || result === void 0 ? void 0 : result.structure) {
                            ...
                            const initialForm = structure.reduce({
                                "AddLocation.useEffect.fetchVehicleFields.initialForm": (acc, tab)=>{
                                    tab.sections.forEach({
                                        "AddLocation.useEffect.fetchVehicleFields.initialForm": (section)=>{
                                            section.fields.forEach({
                                                "AddLocation.useEffect.fetchVehicleFields.initialForm": (field)=>{
                                                    acc[field.key] = field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                                }
                                            }["AddLocation.useEffect.fetchVehicleFields.initialForm"]);
                                        }
                                    }["AddLocation.useEffect.fetchVehicleFields.initialForm"]);
                                    return acc;
                                }
            ...
            }["AddLocation.useEffect.fetchVehicleFields"];
            fetchVehicleFields();
        }
    }["AddLocation.useEffect"], []);
    // === Handlers ===
    ...
    // ✅ Utility: Transform Location Payload Before API Call
...
_s(AddLocation, "152cJxVw2hkJEJ/Vr0FTKH2Ttqo=", false, function() {
    return [
...
//# sourceMappingURL=src_app_ae0fdb8d._.js.map