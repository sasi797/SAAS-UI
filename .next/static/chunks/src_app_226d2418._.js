...
function VehicleList() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VehicleList.useEffect": ()=>{
            ...
            ws.onopen = ({
                "VehicleList.useEffect": ()=>console.log("✅ WebSocket connected")
            })["VehicleList.useEffect"];
            ws.onmessage = ({
                "VehicleList.useEffect": (event)=>{
                    try {
            ...
            ws.onclose = ({
                "VehicleList.useEffect": ()=>console.log("❌ WebSocket disconnected")
            })["VehicleList.useEffect"];
            return ({
                "VehicleList.useEffect": ()=>ws.close()
            })["VehicleList.useEffect"];
        }
    }["VehicleList.useEffect"], [
        dispatch
...
//# sourceMappingURL=src_app_226d2418._.js.map