...
"[project]/src/app/dashboard/consignee-master/edit/[id]/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EditConsignee = ()=>{
    ...
    // === Fetch structure + consignee data ===
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditConsignee.useEffect": ()=>{
            const fetchVehicleData = {
                "EditConsignee.useEffect.fetchVehicleData": async ()=>{
                    try {
                        ...
                        // 2️⃣ Fetch consignee details from API via Redux
                        if (id) {
                            ...
                            console.log("🚗 consignee API Data:", res); // ✅ Check backend data
                        }
                    } catch (error) {
                        console.error("Error fetching consignee form:", error);
                    }
                }
            }["EditConsignee.useEffect.fetchVehicleData"];
            fetchVehicleData();
        }
    }["EditConsignee.useEffect"], [
        id,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditConsignee.useEffect": ()=>{
            if (consignee && Object.keys(consignee).length > 0 && formSchema.length > 0) {
                const initialForm = formSchema.reduce({
                    "EditConsignee.useEffect.initialForm": (acc, tab)=>{
                        tab.sections.forEach({
                            "EditConsignee.useEffect.initialForm": (section)=>{
                                section.fields.forEach({
                                    "EditConsignee.useEffect.initialForm": (field)=>{
                                        // 🔹 Normalize field key (spaces/slashes → underscores)
                                        const normalizedKey = field.key.toLowerCase().replace(/\s+/g, "_").replace(/[\/]+/g, "_");
                                        // 🔹 Debug Log
                                        console.log("🔍 Mapping Field:", field.key, "→", normalizedKey, "| Value from API:", consignee === null || consignee === void 0 ? void 0 : consignee[normalizedKey]);
                                        var _consignee_normalizedKey;
                                        acc[field.key] = (_consignee_normalizedKey = consignee === null || consignee === void 0 ? void 0 : consignee[normalizedKey]) !== null && _consignee_normalizedKey !== void 0 ? _consignee_normalizedKey : field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                    }
                                }["EditConsignee.useEffect.initialForm"]);
                            }
                        }["EditConsignee.useEffect.initialForm"]);
                        return acc;
                    }
    ...
    const handleSave = async ()=>{
        try {
            ...
            console.log("✅ consignee Updated Successfully");
            router.push("/dashboard/consignee-master");
        } catch (error) {
            console.error("❌ Update consignee Failed:", error);
        }
    };
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                variant: "h6",
                                fontWeight: 600,
                                children: "Edit consignee"
                            }, void 0, false, {
                                fileName: "[project]/src/app/dashboard/consignee-master/edit/[id]/page.js",
                                lineNumber: 168,
                                columnNumber: 11
                            }, ("TURBOPACK compile-time value", void 0)),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Typography$3e$__["Typography"], {
                                ...
                                children: "Update the details below to modify this consignee."
                            }, void 0, false, {
                                fileName: "[project]/src/app/dashboard/consignee-master/edit/[id]/page.js",
                                lineNumber: 171,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Button$2f$Button$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Button$3e$__["Button"], {
                                ...
                                onClick: ()=>router.push("/dashboard/consignee-master"),
                                children: "Back"
                            }, void 0, false, {
                                fileName: "[project]/src/app/dashboard/consignee-master/edit/[id]/page.js",
                                lineNumber: 187,
...
_s(EditConsignee, "0ohzRSOc3NiMgjxmv+pvSW1k4+k=", false, function() {
    return [
...
_c = EditConsignee;
const __TURBOPACK__default__export__ = EditConsignee;
var _c;
__turbopack_context__.k.register(_c, "EditConsignee");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_a4b9d32c._.js.map