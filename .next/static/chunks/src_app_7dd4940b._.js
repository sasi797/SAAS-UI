...
const AddRoute = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddRoute.useEffect": ()=>{
            const fetchUserFields = {
                "AddRoute.useEffect.fetchUserFields": async ()=>{
                    ...
                    try {
                        ...
                        if (result === null || result === void 0 ? void 0 : result.structure) {
                            ...
                            const initialForm = structure.reduce({
                                "AddRoute.useEffect.fetchUserFields.initialForm": (acc, tab)=>{
                                    tab.sections.forEach({
                                        "AddRoute.useEffect.fetchUserFields.initialForm": (section)=>{
                                            section.fields.forEach({
                                                "AddRoute.useEffect.fetchUserFields.initialForm": (field)=>{
                                                    acc[field.key] = field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                                }
                                            }["AddRoute.useEffect.fetchUserFields.initialForm"]);
                                        }
                                    }["AddRoute.useEffect.fetchUserFields.initialForm"]);
                                    return acc;
                                }
            ...
            }["AddRoute.useEffect.fetchUserFields"];
            fetchUserFields();
        // eslint-disable-next-line react-hooks/exhaustive-deps
        }
    }["AddRoute.useEffect"], []);
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$userSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createItem"])(encryptedPayloadData)).unwrap();
...
_s(AddRoute, "/pqIzIy0BJQtmYEOn8y//JLTeEU=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "AddRoute");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_7dd4940b._.js.map