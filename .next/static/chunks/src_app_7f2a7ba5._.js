...
"[project]/src/app/dashboard/company-profile/add/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AddCompanyProfile = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddCompanyProfile.useEffect": ()=>{
            const fetchCompanyProfileFields = {
                "AddCompanyProfile.useEffect.fetchCompanyProfileFields": async ()=>{
                    setLoadingFields(true);
                    try {
                        const encryptedResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getApiMethod$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApi"])("fieldindex01/form/company-profile_master");
                        ...
                        if (result === null || result === void 0 ? void 0 : result.structure) {
                            ...
                            const initialForm = structure.reduce({
                                "AddCompanyProfile.useEffect.fetchCompanyProfileFields.initialForm": (acc, tab)=>{
                                    tab.sections.forEach({
                                        "AddCompanyProfile.useEffect.fetchCompanyProfileFields.initialForm": (section)=>{
                                            section.fields.forEach({
                                                "AddCompanyProfile.useEffect.fetchCompanyProfileFields.initialForm": (field)=>{
                                                    acc[field.key] = field.type === "multiselect" ? [] : field.type === "switch" ? false : "";
                                                }
                                            }["AddCompanyProfile.useEffect.fetchCompanyProfileFields.initialForm"]);
                                        }
                                    }["AddCompanyProfile.useEffect.fetchCompanyProfileFields.initialForm"]);
                                    return acc;
                                }
            ...
            }["AddCompanyProfile.useEffect.fetchCompanyProfileFields"];
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$features$2f$companyProfileSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createItem"])(encryptedPayloadData)).unwrap();
...
_s(AddCompanyProfile, "3Q1o1eLOPAwpvxCOJnx7I0Cm1O0=", false, function() {
    return [
...
_c = AddCompanyProfile;
const __TURBOPACK__default__export__ = AddCompanyProfile;
var _c;
__turbopack_context__.k.register(_c, "AddCompanyProfile");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_7f2a7ba5._.js.map