...
const AddVehicle = ()=>{
    ...
    const handleSave = async ()=>{
        try {
            ...
            const res = await postApi("/vehicles", form);
            if ((res === null || res === void 0 ? void 0 : res.status_code) === 201 || (res === null || res === void 0 ? void 0 : res.status_code) === 200) {
                setSnackbar({
                    open: true,
...
_s(AddVehicle, "/3KaRFRFJq18+k0jIwHx+hmZmOk=", false, function() {
    return [
...
//# sourceMappingURL=src_6ab9985f._.js.map